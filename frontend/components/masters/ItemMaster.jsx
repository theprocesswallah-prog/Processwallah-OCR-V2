...
export default function ItemMaster() {
  ...
  async function handleDelete(row) {
    if (!confirm(`Delete ${cfg.label} ${row.code || row[cfg.pk]}? This action cannot be undone.`)) return;
    await remove(row[cfg.pk]);
  }

  return (
    <section>
      <Breadcrumb masterLabel={`${cfg.label} Master`} mastersLink="/item-master" />
